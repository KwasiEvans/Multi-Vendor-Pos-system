@include('vendor.layouts.includes.dashboard_head')
...
<img src="{{asset('vendor_assets/img/logo.png')}}" alt="">
</a>
<a href="index.html" class="logo-small">
<img src="{{asset('vendor_assets/img/logo-small.png')}}" alt="">
</a>
...
<span><img src="{{asset('vendor_assets/img/icons/closes.svg')}}" alt="img"></span>
</div>
</div>
<a class="btn" id="searchdiv"><img src="{{asset('vendor_assets/img/icons/search.svg')}}" alt="img"></a>
</form>
</div>
</li>
...
<img src="{{asset('vendor_assets/img/flags/us1.png')}}" alt="" height="20">
</a>
</li>
...
<div class="media d-flex">
<span class="avatar flex-shrink-0">
<img alt="" src="{{asset('vendor_assets/img/profiles/avatar-03.jpg')}}">
</span>
<div class="media-body flex-grow-1">
...
<div class="media d-flex">
<span class="avatar flex-shrink-0">
<img alt="" src="{{asset('vendor_assets/img/profiles/avatar-06.jpg')}}">
</span>
<div class="media-body flex-grow-1">
...
<div class="media d-flex">
<span class="avatar flex-shrink-0">
<img alt="" src="{{asset('vendor_assets/img/profiles/avatar-17.jpg')}}">
</span>
<div class="media-body flex-grow-1">
...
<form  action="{{ route('logout') }}" method="post"> @csrf
    <button class="dropdown-item logout pb-0" type="submit"><img src="{{asset('vendor_assets/img/icons/log-out.svg')}}" class="me-2" alt="img">Logout</button>
</form>
...
@include('vendor.layouts.includes.dashboard_script')